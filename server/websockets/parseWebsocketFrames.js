...
export default function* parseWebsocketFrames (
    ...
    while(true) {
        ...
        /*
         * Parse a WebSocket message based on The WebSocket Protocol, as 
         * specified by the Request For Comments 6455 (RFC 6455) by the IETF, 
         * see https://tools.ietf.org/html/rfc6455.
         *
         * Per Section 5.2 of the specification, a base frame takes the 
         * following form, in terms of bits (1's and 0's). The visualization 
         * is wrapped at the 32nd bit:
            ...
            case 127:
                ...
                */
                ...
                const most_significant_bit_is_zero = 
                    messagesUint8[2] < (Math.pow(2, 8));
                
                if(!most_significant_bit_is_zero)
                    throw new Error(
                        `Most significant bit of a 64-bit extended payload ` +
                        `length must be zero`
                    );
                ...
                payload_length_value =
                    parseInt((
                        [
                            ...
                            ...uint2ArrayFromUint8Value(messagesUint8[2]), // 1
                            ...uint2ArrayFromUint8Value(messagesUint8[3]), // 2
                            ...uint2ArrayFromUint8Value(messagesUint8[4]), // 3
                            ...uint2ArrayFromUint8Value(messagesUint8[5]), // 4
                            ...uint2ArrayFromUint8Value(messagesUint8[6]), // 5
                            ...uint2ArrayFromUint8Value(messagesUint8[7]), // 6
                            ...uint2ArrayFromUint8Value(messagesUint8[8]), // 7
                            ...uint2ArrayFromUint8Value(messagesUint8[9]) // 8
                        ].join('')
                    ), 2 /* base */);
...
------------------------------ end of quotation -------------------------------
        ...
        if(
            ...
            (
                ...
                + 
                (
                    has_extended_payload_length_16 ? 2 :
                        has_extended_payload_length_63 ? 8 : 0
                )
                + 
